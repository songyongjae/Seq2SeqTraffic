...
output_dir = 'clustered1'  # 분류된 이미지가 저장될 디렉토리
...
df1.to_excel('features1.xlsx', index=False)
...
df2.to_excel('pca1.xlsx', index=False)
...
df_weights.to_excel('cluster_weights1.xlsx', index=False)
